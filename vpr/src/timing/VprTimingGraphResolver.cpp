...
void VprTimingGraphResolver::get_detailed_interconnect_components_helper(std::vector<tatum::DelayComponent>& components, RouteTreeNode& node) const {
    ...
    vtr::optional<RouteTreeNode&> current_node = node;
    while (current_node) {
